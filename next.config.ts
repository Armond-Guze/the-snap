...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const baseCsp = [
      ...
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://core.sanity-cdn.com https://cdn.sanity.io https://*.sanity.build https://*.sanity.tools https://*.sanity.studio https://pagead2.googlesyndication.com https://www.googletagmanager.com https://www.googlesyndication.com https://securepubads.g.doubleclick.net https://va.vercel-scripts.com https://*.clerk.com https://*.clerk.accounts.dev https://*.clerk.accounts.com https://clerk.thegamesnap.com https://www.google.com https://*.google.com https://www.gstatic.com https://www.gstatic.com/recaptcha/ https://www.recaptcha.net https://recaptcha.net https://challenges.cloudflare.com https://platform.twitter.com;",
