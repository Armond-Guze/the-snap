...
export function generateSEOMetadata(
  ...
  const ogImageUrl = extendedSeo?.ogImage?.asset?.url || coverImage?.asset?.url || '/images/thesnap-logo-transparent.png'
...
export function generateCategorySEOMetadata(
  ...
  const ogImageUrl = extendedSeo?.ogImage?.asset?.url || '/images/thesnap-logo-transparent.png'
