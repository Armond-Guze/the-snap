...
export function generateSEOMetadata(
  ...
  const ogImageUrl = extendedSeo?.ogImage?.asset?.url || coverImage?.asset?.url || '/images/logo--design copy.png'
...
export function generateCategorySEOMetadata(
  ...
  const ogImageUrl = extendedSeo?.ogImage?.asset?.url || '/images/logo--design copy.png'
