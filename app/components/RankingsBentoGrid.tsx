...
export default async function RankingsBentoGrid({ textureSrc, hideSummaries = false }: RankingsBentoGridProps) {
  ...
  <div className="mb-4 2xl:mb-5 3xl:mb-6">
          <div className="flex flex-wrap items-center gap-8 mb-3">
            <h2 className="text-lg sm:text-xl 2xl:text-xl 3xl:text-2xl font-bold text-gray-300 tracking-tight">
              Latest Rankings
            </h2>
          </div>
        </div>
              ...
              <Link href={getRankingUrl(mainRanking)} className="group">
                <div className="relative h-full min-h-[380px] 2xl:min-h-[460px] 3xl:min-h-[520px] rounded-xl overflow-hidden bg-gray-900 hover:bg-gray-800 transition-all duration-400 hover:scale-[1.005] shadow-lg hover:shadow-xl">
                  ...
                  <div className="relative h-full flex flex-col justify-between p-6 2xl:p-7 3xl:p-8">
                    ...
                    <div>
                      <h3 className="text-xl lg:text-2xl 2xl:text-3xl 3xl:text-4xl font-bold text-white mb-3 line-clamp-3 group-hover:text-gray-300 transition-colors duration-300">
                        {mainRanking.title}
                      </h3>
                      {(mainRanking.summary || mainRanking.excerpt) && !hideSummaries && (
            ...
            {sideRankings[0] && sideRankings[0].slug?.current ? (
              <Link href={getRankingUrl(sideRankings[0])} className="group">
                <div className="relative h-[200px] 2xl:h-[230px] 3xl:h-[260px] rounded-lg overflow-hidden bg-gray-900 hover:bg-gray-800 transition-all duration-400 hover:scale-[1.005] shadow-lg hover:shadow-xl">
                  ...
                  <div className="relative h-full flex flex-col justify-between p-5 2xl:p-6">
                    <div className="flex items-start justify-end">
                    ...
                    <div>
                      <h3 className="text-base 2xl:text-lg 3xl:text-xl font-bold text-white line-clamp-2 group-hover:text-gray-300 transition-colors duration-300">
                        {sideRankings[0].title}
                      </h3>
                      {(sideRankings[0].summary || sideRankings[0].excerpt) && !hideSummaries && (
                ...
                <div className="relative h-[200px] 2xl:h-[230px] 3xl:h-[260px] rounded-lg overflow-hidden bg-gray-900 hover:bg-gray-800 transition-all duration-400 hover:scale-[1.005] shadow-lg hover:shadow-xl">
                  ...
                  <div className="relative h-full flex flex-col justify-between p-5 2xl:p-6">
                    ...
                    <div>
                      ...
                      {(sideRankings[1].summary || sideRankings[1].excerpt) && !hideSummaries && (
                        <p className="text-gray-300 text-sm 2xl:text-base 3xl:text-lg line-clamp-2 mt-2">
