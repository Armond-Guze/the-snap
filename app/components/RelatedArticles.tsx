...
export default function RelatedArticles({ 
  ...
  return (
    <div className="bg-white backdrop-blur-sm rounded-2xl p-2 border border-neutral-200 shadow-[0_0_0_1px_rgba(255,255,255,0.04)]">
      <h2 className="px-1 pb-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-neutral-600">
        Keep Reading
      </h2>
        ...
        {relatedArticles.map((article) => {
          ...
          return (
            <Link
              ...
              className="group block focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 rounded-lg"
            >
              <div className="flex gap-3 rounded-lg border border-neutral-200 bg-neutral-50 p-2.5 transition-colors hover:bg-neutral-50">
                <div className="relative h-14 w-[76px] flex-shrink-0 overflow-hidden rounded-md bg-neutral-100 lg:h-16 lg:w-20">
                  {img ? (
                    <Image
                      src={img}
                      alt={article.title}
                ...
                <div className="min-w-0 flex-1 flex flex-col">
                  <h3 className="line-clamp-2 text-[12.5px] lg:text-[13px] font-semibold leading-snug text-neutral-900 group-hover:text-neutral-700 transition-colors">
                    {article.homepageTitle || article.title}
                  </h3>
                  <div className="mt-1.5 flex flex-wrap items-center gap-x-2.5 gap-y-1 text-[9.5px] lg:text-[10px] text-neutral-500">
