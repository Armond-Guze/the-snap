        ...
        <div className="md:hidden flex items-center justify-between h-full relative">
          ...
          <Link href="/" className="inline-flex items-center space-x-2 group absolute left-1/2 transform -translate-x-1/2">
            <Image
              ...
              width={80}
              height={80}
              className="h-10 w-auto md:h-11 transition-transform group-hover:scale-102"
              priority
            />
          </Link>
        ...
        <div className="hidden md:flex items-center justify-between h-full">
          ...
          <Link href="/" className="inline-flex items-center space-x-2 group">
            <Image
              ...
              width={80}
              height={80}
              className="h-10 md:h-14 lg:h-16 w-auto transition-transform group-hover:scale-102"
              priority
            />
          </Link>
