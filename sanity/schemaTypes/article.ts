    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          title: "Supporting Research Summary",
          type: "text",
          rows: 3,
          readOnly: true,
        }),
        defineField({
          ...
          title: "Distinct Information Added",
          type: "array",
          of: [{ type: "string" }],
          readOnly: true,
        }),
        ...
        defineField({
          name: "supportingResearchFacts",
          title: "Claim-Level Supporting Research",
          type: "array",
          of: [
            defineArrayMember({
              type: "object",
              fields: [
                ...
                defineField({ name: "sourceDate", title: "Source Date", type: "string" }),
                defineField({ name: "metricContext", title: "Metric Context", type: "text", rows: 2 }),
              ],
            }),
          ],
          readOnly: true,
        ...
        defineField({
          ...
          title: "Evidence Artifact Type",
          type: "string",
          readOnly: true,
        }),
        defineField({
          name: "evidenceArtifactTitle",
          title: "Evidence Artifact Title",
          type: "string",
          readOnly: true,
        }),
        defineField({
